...
@allure.feature('C客户删除某个订单下的包裹信息')
class Test_app_user_orders_delete(object):
    ...
    @pytest.mark.parametrize("address",['/api/user/v1/orders/delete/$app_user_ticket_orders_list_0_0_["data"][1]["id"]$'])
    @pytest.mark.run(order=40)
    def test_test_app_user_orders_delete(self,headers,address):
        ...
        _address = ['/api/user/v1/orders/delete/$app_user_ticket_orders_list_0_0_["data"][1]["id"]$']
