...
@allure.feature('C客户取消订单')
class Test_app_user_ticket_cancel(object):
    ...
    @pytest.mark.parametrize("address",['/api/user/v1/ticket/cancel/$app_user_ticket_pickup_list_0_0_["data"]["list"][2]["id"]$'])
    @pytest.mark.run(order=41)
    def test_test_app_user_ticket_cancel(self, parameter,headers,address):
        ...
        _address = ['/api/user/v1/ticket/cancel/$app_user_ticket_pickup_list_0_0_["data"]["list"][2]["id"]$']
