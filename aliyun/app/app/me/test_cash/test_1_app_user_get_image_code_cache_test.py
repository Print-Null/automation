...
class Test_app_user_get_image_code(object):
    ...
    def test_test_app_user_get_image_code(self, parameter,headers,address):
        ...
        logging.info("jsonschema文件path:../data/jsonschema/1_app_user_get_image_code.json")
        with open("../data/jsonschema/1_app_user_get_image_code.json", "r", encoding = "utf-8") as f:
            shcema = json.load(f)
