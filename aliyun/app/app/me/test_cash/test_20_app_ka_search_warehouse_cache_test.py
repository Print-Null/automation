...
class Test_app_ka_search_warehouse(object):
    ...
    def test_test_app_ka_search_warehouse(self,headers,address):
        ...
        logging.info("jsonschema文件path:../data/jsonschema/20_app_ka_search_warehouse.json")
        with open("../data/jsonschema/20_app_ka_search_warehouse.json", "r", encoding = "utf-8") as f:
            shcema = json.load(f)
