...
class Test_app_ka_address_resolution(object):
    ...
    def test_test_app_ka_address_resolution(self, parameter,headers,address):
        ...
        logging.info("jsonschema文件path:../data/jsonschema/23_app_ka_address_resolution.json")
        with open("../data/jsonschema/23_app_ka_address_resolution.json", "r", encoding = "utf-8") as f:
            shcema = json.load(f)
