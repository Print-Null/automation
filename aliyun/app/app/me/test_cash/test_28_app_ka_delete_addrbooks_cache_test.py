...
@allure.feature('B客户删除地址')
class Test_app_ka_delete_addrbooks(object):
    ...
    def test_test_app_ka_delete_addrbooks(self, parameter,headers,address):
        ...
        logging.info("jsonschema文件path:../data/jsonschema/28_app_ka_delete_addrbooks.json")
        with open("../data/jsonschema/28_app_ka_delete_addrbooks.json", "r", encoding = "utf-8") as f:
            shcema = json.load(f)
