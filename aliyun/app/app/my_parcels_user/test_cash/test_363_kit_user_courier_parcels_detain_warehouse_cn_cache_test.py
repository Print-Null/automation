...
class Test_kit_user_courier_parcels_detain_warehouse_cn(object):
    ...
    @pytest.mark.parametrize("headers",['{\'Accept-Language\': \'en-US\', \'content-type\': \'application/json; charset=UTF-8\', \'X-FLE-SESSION-ID\': \'$kit_get_user_warehouse_id_and_login_cn_["data"]["sessionid"]$\'}'])
    ...
    def test_test_kit_user_courier_parcels_detain_warehouse_cn(self, parameter,headers,address):
        ...
        _headers = ['{\'Accept-Language\': \'en-US\', \'content-type\': \'application/json; charset=UTF-8\', \'X-FLE-SESSION-ID\': \'$kit_get_user_warehouse_id_and_login_cn_["data"]["sessionid"]$\'}']
