...
class Test_kit_user_sender_courier_ticket_pickups_confirm_cn(object):
    ...
    @pytest.mark.parametrize("parameter",['{\'width\': \'$[python]random.randint(1,40)$\', \'weight\': \'$[python]random.randrange(10,15001,10)$\', \'user_order_id\': \'$kit_user_sender_courier_ticket_pickups_cn_0_0_["data"]["not_collected_parcels"][0]["user_order_id"]$\', \'src_province_code\': \'$[config]user_src_province_code$\', \'src_district_code\': \'$[config]user_src_district_code$\', \'src_city_code\': \'$[config]user_src_city_code$\', \'src_country_code\': \'TH\', \'src_postal_code\': \'$[config]user_src_postal_code$\', \'dst_detail_address\': \'$[config]user_dst_detail_address$\', \'dst_country_code\': \'TH\', \'dst_city_code\': \'$[config]user_dst_city_code$\', \'dst_province_code\': \'$[config]user_dst_province_code$\', \'dst_postal_code\': \'$[config]user_dst_postal_code$\', \'dst_district_code\': \'$[config]user_dst_district_code$\', \'dst_home_phone\': \'\', \'dst_name\': \'$[config]user_dst_name$\', \'dst_phone\': \'$[config]user_dst_phone$\', \'src_phone\': \'$[config]user_src_phone$\', \'height\': \'$[python]random.randint(1,40)$\', \'insure_declare_value\': 0, \'src_name\': \'$[config]user_src_name$\', \'length\': \'$[python]random.randint(1,40)$\', \'src_detail_address\': \'$[config]user_src_detail_address$\', \'call_duration\': 0, \'insured\': False, \'freight_insure_enabled\': False, \'express_category\': 1, \'cod_enabled\': False, \'total_amount\': 4500, \'cod_amount\': 0, \'settlement_category\': 1, \'article_category\': \'$[python]random.choice([0,1,2,3,4,5,6,7,9,10,99])$\'}', '{\'width\': \'$[python]random.randint(1,40)$\', \'weight\': \'$[python]random.randrange(10,15001,10)$\', \'user_order_id\': \'$kit_user_sender_courier_ticket_pickups_cn_0_0_["data"]["not_collected_parcels"][1]["user_order_id"]$\', \'src_province_code\': \'$[config]user_src_province_code$\', \'src_district_code\': \'$[config]user_src_district_code$\', \'src_city_code\': \'$[config]user_src_city_code$\', \'src_country_code\': \'TH\', \'src_postal_code\': \'$[config]user_src_postal_code$\', \'dst_detail_address\': \'$[config]user_dst_detail_address$\', \'dst_country_code\': \'TH\', \'dst_city_code\': \'$[config]user_dst_city_code$\', \'dst_province_code\': \'$[config]user_dst_province_code$\', \'dst_postal_code\': \'$[config]user_dst_postal_code$\', \'dst_district_code\': \'$[config]user_dst_district_code$\', \'dst_home_phone\': \'\', \'dst_name\': \'$[config]user_dst_name$\', \'dst_phone\': \'$[config]user_dst_phone$\', \'src_phone\': \'$[config]user_src_phone$\', \'height\': \'$[python]random.randint(1,40)$\', \'insure_declare_value\': 0, \'src_name\': \'$[config]user_src_name$\', \'length\': \'$[python]random.randint(1,40)$\', \'src_detail_address\': \'$[config]user_src_detail_address$\', \'call_duration\': 0, \'insured\': False, \'freight_insure_enabled\': False, \'express_category\': 1, \'cod_enabled\': False, \'total_amount\': 4500, \'cod_amount\': 0, \'settlement_category\': 1, \'article_category\': \'$[python]random.choice([0,1,2,3,4,5,6,7,9,10,99])$\'}', '{\'width\': \'$[python]random.randint(1,40)$\', \'weight\': \'$[python]random.randrange(10,15001,10)$\', \'user_order_id\': \'$kit_user_sender_courier_ticket_pickups_cn_0_0_["data"]["not_collected_parcels"][2]["user_order_id"]$\', \'src_province_code\': \'$[config]user_src_province_code$\', \'src_district_code\': \'$[config]user_src_district_code$\', \'src_city_code\': \'$[config]user_src_city_code$\', \'src_country_code\': \'TH\', \'src_postal_code\': \'$[config]user_src_postal_code$\', \'dst_detail_address\': \'$[config]user_dst_detail_address$\', \'dst_country_code\': \'TH\', \'dst_city_code\': \'$[config]user_dst_city_code$\', \'dst_province_code\': \'$[config]user_dst_province_code$\', \'dst_postal_code\': \'$[config]user_dst_postal_code$\', \'dst_district_code\': \'$[config]user_dst_district_code$\', \'dst_home_phone\': \'\', \'dst_name\': \'$[config]user_dst_name$\', \'dst_phone\': \'$[config]user_dst_phone$\', \'src_phone\': \'$[config]user_src_phone$\', \'height\': \'$[python]random.randint(1,40)$\', \'insure_declare_value\': 0, \'src_name\': \'$[config]user_src_name$\', \'length\': \'$[python]random.randint(1,40)$\', \'src_detail_address\': \'$[config]user_src_detail_address$\', \'call_duration\': 0, \'insured\': False, \'freight_insure_enabled\': False, \'express_category\': 1, \'cod_enabled\': False, \'total_amount\': 4500, \'cod_amount\': 0, \'settlement_category\': 1, \'article_category\': \'$[python]random.choice([0,1,2,3,4,5,6,7,9,10,99])$\'}'])
    @pytest.mark.parametrize("headers",['{\'Accept-Language\': \'th-TH\', \'content-type\': \'application/json; charset=UTF-8\', \'X-FLE-SESSION-ID\': \'$kit_user_sender_courier_new_device_login_cn_0_0_0_["data"]["sessionid"]$\'}'])
    ...
    def test_test_kit_user_sender_courier_ticket_pickups_confirm_cn(self, parameter,headers,address):
        ...
        _headers = ['{\'Accept-Language\': \'th-TH\', \'content-type\': \'application/json; charset=UTF-8\', \'X-FLE-SESSION-ID\': \'$kit_user_sender_courier_new_device_login_cn_0_0_0_["data"]["sessionid"]$\'}']
