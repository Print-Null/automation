...
class Test_kit_user_sender_courier_parcels_delivery_ticket_creation_scan_cn(object):
    ...
    @pytest.mark.parametrize("headers",['{\'content-type\': \'application/json; charset=UTF-8\', \'Accept-Language\': \'th-TH\', \'X-FLE-SESSION-ID\': \'$kit_user_sender_courier_new_device_login_cn_0_0_0_["data"]["sessionid"]$\'}'])
    ...
    def test_test_kit_user_sender_courier_parcels_delivery_ticket_creation_scan_cn(self, parameter,headers,address):
        ...
        _headers = ['{\'content-type\': \'application/json; charset=UTF-8\', \'Accept-Language\': \'th-TH\', \'X-FLE-SESSION-ID\': \'$kit_user_sender_courier_new_device_login_cn_0_0_0_["data"]["sessionid"]$\'}']
