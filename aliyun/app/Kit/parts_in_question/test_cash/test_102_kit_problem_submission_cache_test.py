...
@allure.feature('仓管员问题单提交-货物短少')
class Test_kit_problem_submission(object):

    @pytest.mark.parametrize("parameter",['{\'difficulty_marker_category\': 21, \'image_keys\': [\'$kit_v1_parcels_#headers#_0_["data"]["object_key"]$\'], \'remark\': \'货物短少\'}'])
    ...
    def test_test_kit_problem_submission(self, parameter,headers,address):
        ...
        _parameter = ['{\'difficulty_marker_category\': 21, \'image_keys\': [\'$kit_v1_parcels_#headers#_0_["data"]["object_key"]$\'], \'remark\': \'货物短少\'}']
