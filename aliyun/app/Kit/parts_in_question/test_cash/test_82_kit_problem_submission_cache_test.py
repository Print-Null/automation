...
@allure.feature('仓管员问题单提交-收件人手机号码是空号')
class Test_kit_problem_submission(object):

    @pytest.mark.parametrize("parameter",['{\'difficulty_marker_category\': 29, \'image_keys\': [\'$kit_v1_parcels_#headers#_0_["data"]["object_key"]$\'], \'remark\': \'收件人电话号码是空号\'}'])
    ...
    def test_test_kit_problem_submission(self, parameter,headers,address):
        ...
        _parameter = ['{\'difficulty_marker_category\': 29, \'image_keys\': [\'$kit_v1_parcels_#headers#_0_["data"]["object_key"]$\'], \'remark\': \'收件人电话号码是空号\'}']
