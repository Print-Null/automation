...
@allure.feature('仓管员问题单提交-仅外包装破损')
class Test_kit_problem_submission(object):

    @pytest.mark.parametrize("parameter",['{\'difficulty_marker_category\': 19, \'image_keys\': [\'$kit_v1_parcels_pre_#headers#_0_["data"]["object_key"]$\', \'$kit_v1_parcels_aft_#headers#_0_["data"]["object_key"]$\'], \'remark\': \'仅外包装破损\'}'])
    ...
    def test_test_kit_problem_submission(self, parameter,headers,address):
        ...
        _parameter = ['{\'difficulty_marker_category\': 19, \'image_keys\': [\'$kit_v1_parcels_pre_#headers#_0_["data"]["object_key"]$\', \'$kit_v1_parcels_aft_#headers#_0_["data"]["object_key"]$\'], \'remark\': \'仅外包装破损\'}']
