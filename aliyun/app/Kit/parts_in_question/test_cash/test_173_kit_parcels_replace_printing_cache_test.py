...
@allure.feature('仓管员问题单提交-分错网点-地址错误-换单打印')
class Test_kit_parcels_replace_printing(object):

    @pytest.mark.parametrize("parameter",['{\'pno\': \'$kit_pickups_parcel_0_#headers#_0_["data"]["parcel_info"]["pno"]$\'}'])
    ...
    @pytest.mark.parametrize("address",['api/courier/v1/parcels/replace_printing'])
    @pytest.mark.run(order=173)
    def test_test_kit_parcels_replace_printing(self, parameter,headers,address):
        baseTest = BaseTestCase()
    
        _parameter = ['{\'pno\': \'$kit_pickups_parcel_0_#headers#_0_["data"]["parcel_info"]["pno"]$\'}']
        ...
        _address = ['api/courier/v1/parcels/replace_printing']
