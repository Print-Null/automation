...
@allure.feature('仓管员问题单提交-COD 金额不正确')
class Test_kit_problem_submission(object):

    @pytest.mark.parametrize("parameter",['{\'difficulty_marker_category\': 26, \'image_keys\': [\'$kit_v1_parcels_#headers#_0_["data"]["object_key"]$\'], \'remark\': \'COD 金额不正确\'}'])
    ...
    def test_test_kit_problem_submission(self, parameter,headers,address):
        ...
        _parameter = ['{\'difficulty_marker_category\': 26, \'image_keys\': [\'$kit_v1_parcels_#headers#_0_["data"]["object_key"]$\'], \'remark\': \'COD 金额不正确\'}']
