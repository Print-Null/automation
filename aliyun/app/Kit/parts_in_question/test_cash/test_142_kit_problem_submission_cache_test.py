...
@allure.feature('仓管员问题单提交-收件人电话号码错误')
class Test_kit_problem_submission(object):

    @pytest.mark.parametrize("parameter",['{\'difficulty_marker_category\': 25, \'image_keys\': [\'$kit_v1_parcels_#headers#_0_["data"]["object_key"]$\'], \'remark\': \'收件人电话号码错误\'}'])
    ...
    def test_test_kit_problem_submission(self, parameter,headers,address):
        ...
        _parameter = ['{\'difficulty_marker_category\': 25, \'image_keys\': [\'$kit_v1_parcels_#headers#_0_["data"]["object_key"]$\'], \'remark\': \'收件人电话号码错误\'}']
