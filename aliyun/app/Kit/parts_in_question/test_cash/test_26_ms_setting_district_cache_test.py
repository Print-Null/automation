...
class Test_ms_setting_district(object):
    ...
    @pytest.mark.parametrize("address",['ms/api/setting/district?name=&pageSize=20&pageNum=1&upcountry=1&countryCode=&provinceCode=&cityCode=&districtCode=&storeId=&keyWord='])
    ...
    def test_test_ms_setting_district(self,headers,address):
        ...
        _address = ['ms/api/setting/district?name=&pageSize=20&pageNum=1&upcountry=1&countryCode=&provinceCode=&cityCode=&districtCode=&storeId=&keyWord=']
