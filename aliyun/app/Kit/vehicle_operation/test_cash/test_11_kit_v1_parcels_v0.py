...
class Test_kit_v1_parcels_v0(object):
    ...
    @pytest.mark.parametrize("headers", [
        ...
        '{\'content-type\': \'application/json\', \'Accept-Language\': \'en-US\', \'X-FLE-SESSION-ID\': \'$kit_auth_new_device_login_1_1_0_["data"]["sessionid"]$\'}',
        '{\'content-type\': \'application/json\', \'Accept-Language\': \'th-TN\', \'X-FLE-SESSION-ID\': \'$kit_auth_new_device_login_1_2_0_["data"]["sessionid"]$\'}'])
    ...
    def test_test_kit_v1_parcels_v0(self, headers, address):
        ...
        # logging.info("jsonschema文件path:../data/jsonschema/11_view_express_details.json")
        # with open("../data/jsonschema/11_view_express_details.json", "r", encoding="utf-8") as f:
        #     shcema = json.load(f)
