...
class Test_ms_proof_line(object):
    ...
    def test_test_ms_proof_line(self, parameter,headers,address):
        ...
        # logging.info("jsonschema文件path:../data/jsonschema/22_print_the_vehicle_delivery_certificate_1.json")
        # with open("../data/jsonschema/22_print_the_vehicle_delivery_certificate_1.json", "r", encoding = "utf-8") as f:
        #     shcema = json.load(f)
