...
@allure.feature('仓管员-入港考勤')
class Test_kit_inBound_attendance(object):
    ...
    @pytest.mark.parametrize("address",['api/courier/v1/fleet/proof/inBound/attendance/$ms_van_proof_0_#headers#_0_["data"]["id"]$?isFromScanner=false'])
    @pytest.mark.run(order=32)
    def test_test_kit_inBound_attendance(self, parameter,headers,address):
        ...
        _address = ['api/courier/v1/fleet/proof/inBound/attendance/$ms_van_proof_0_#headers#_0_["data"]["id"]$?isFromScanner=false']
