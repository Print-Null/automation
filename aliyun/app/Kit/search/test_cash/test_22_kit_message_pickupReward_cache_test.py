...
@allure.feature('快递员-查件-输入订单号-不可打印')
class Test_kit_message_pickupReward(object):
    ...
    @pytest.mark.parametrize("address",['api/courier/v1/parcels/$kit_pickups_parcel_0_0_0_["data"]["parcel_info"]["pno"]$/find_v0?isFromScanner=false', 'api/courier/v1/parcels/$kit_pickups_parcel_0_1_0_["data"]["parcel_info"]["pno"]$/find_v0?isFromScanner=false', 'api/courier/v1/parcels/$kit_pickups_parcel_0_2_0_["data"]["parcel_info"]["pno"]$/find_v0?isFromScanner=false'])
    ...
    def test_test_kit_message_pickupReward(self,headers,address):
        ...
        assert_that(str(resp.json()["data"]["print"]).lower() == "false").is_true()
