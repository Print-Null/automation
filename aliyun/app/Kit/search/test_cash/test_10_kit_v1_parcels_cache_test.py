...
@allure.feature('快递员-查件-输入订单号-打印面签可点击')
class Test_kit_v1_parcels(object):
    ...
    @pytest.mark.parametrize("address",['api/courier/v1/parcels/$kit_pickups_parcel_0_0_0_["data"]["parcel_info"]["pno"]$/find_v0?isFromScanner=false'])
    ...
    def test_test_kit_v1_parcels(self,headers,address):
        ...
        _address = ['api/courier/v1/parcels/$kit_pickups_parcel_0_0_0_["data"]["parcel_info"]["pno"]$/find_v0?isFromScanner=false']
        ...
        assert_that(str(resp.json()["data"]["print"]).lower() == "true").is_true()
