...
class Test_kit_delivery_ticket_creation_scan(object):
    ...
    @pytest.mark.parametrize("address",['api/courier/v1/parcels/$kit_pickups_parcel_0_0_0_["data"]["parcel_info"]["pno"]$/delivery_ticket_creation_scan?isFromScanner=false', 'api/courier/v1/parcels/$kit_pickups_parcel_0_1_0_["data"]["parcel_info"]["pno"]$/delivery_ticket_creation_scan?isFromScanner=false', 'api/courier/v1/parcels/$kit_pickups_parcel_0_2_0_["data"]["parcel_info"]["pno"]$/delivery_ticket_creation_scan?isFromScanner=false'])
