...
@allure.feature('代收货款-COD-提交揽件信息')
class Test_kit_pickups_parcel(object):
    ...
    def test_test_kit_pickups_parcel(self, parameter,headers,address):
        ...
        # logging.info("jsonschema文件path:../data/jsonschema/6_submit_solicitation_information.json")
        # with open("../data/jsonschema/6_submit_solicitation_information.json", "r", encoding = "utf-8") as f:
        #     shcema = json.load(f)
