...
class Test_kit_parcels_print_single(object):
    ...
    @pytest.mark.parametrize("address",['api/courier/v1/parcel_print/$kit_pickups_parcel_0_0_0_["data"]["parcel_info"]["pno"]$'])
    @pytest.mark.run(order=54)
    def test_test_kit_parcels_print_single(self,headers,address):
        ...
        _address = ['api/courier/v1/parcel_print/$kit_pickups_parcel_0_0_0_["data"]["parcel_info"]["pno"]$']
        ...
        # logging.info("jsonschema文件path:../data/jsonschema/54_storekeeper_get_the_modified_order_information.json")
        # with open("../data/jsonschema/54_storekeeper_get_the_modified_order_information.json", "r", encoding = "utf-8") as f:
        #     shcema = json.load(f)
