...
@allure.feature('代收货款-COD-输入收件人地址')
class Test_kit_recommend_addressRecommend(object):
    ...
    def test_test_kit_recommend_addressRecommend(self, parameter,headers,address):
        ...
        # logging.info("jsonschema文件path:../data/jsonschema/5_choose_recipient_addressee_details.json")
        # with open("../data/jsonschema/5_choose_recipient_addressee_details.json", "r", encoding = "utf-8") as f:
        #     shcema = json.load(f)
