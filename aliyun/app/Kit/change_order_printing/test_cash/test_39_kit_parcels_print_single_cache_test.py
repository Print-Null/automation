...
@allure.feature('仓管员-换单打印-修改订单信息-提交')
class Test_kit_parcels_print_single(object):
    ...
    def test_test_kit_parcels_print_single(self, parameter,headers,address):
        ...
        # logging.info("jsonschema文件path:../data/jsonschema/39_storekeeper_change_order_commit.json")
        # with open("../data/jsonschema/39_storekeeper_change_order_commit.json", "r", encoding = "utf-8") as f:
        #     shcema = json.load(f)
