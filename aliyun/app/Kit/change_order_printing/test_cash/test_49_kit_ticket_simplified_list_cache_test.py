...
@allure.feature('快递员-待完成列表')
class Test_kit_ticket_simplified_list(object):
    ...
    def test_test_kit_ticket_simplified_list(self,headers,address):
        ...
        # logging.info("jsonschema文件path:../data/jsonschema/23_uncompleted_list.json")
        # with open("../data/jsonschema/23_uncompleted_list.json", "r", encoding = "utf-8") as f:
        #     shcema = json.load(f)
