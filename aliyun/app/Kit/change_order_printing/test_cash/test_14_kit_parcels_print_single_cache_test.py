...
class Test_kit_parcels_print_single(object):
    ...
    def test_test_kit_parcels_print_single(self,headers,address):
        ...
        # logging.info("jsonschema文件path:../data/jsonschema/14_courier_get_the_modified_order_information.json")
        # with open("../data/jsonschema/14_courier_get_the_modified_order_information.json", "r", encoding = "utf-8") as f:
        #     shcema = json.load(f)
