...
@allure.feature('代收货款-COD-揽收完成-1')
class Test_kit_v1_ticket(object):
    ...
    def test_test_kit_v1_ticket(self, parameter,headers,address):
        ...
        # logging.info("jsonschema文件path:../data/jsonschema/7_collection_completed_1.json")
        # with open("../data/jsonschema/7_collection_completed_1.json", "r", encoding = "utf-8") as f:
        #     shcema = json.load(f)
