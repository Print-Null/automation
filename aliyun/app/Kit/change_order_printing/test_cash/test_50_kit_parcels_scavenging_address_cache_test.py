...
class Test_kit_parcels_scavenging_address(object):
    ...
    def test_test_kit_parcels_scavenging_address(self, parameter,headers,address):
        ...
        # logging.info("jsonschema文件path:../data/jsonschema/50_storekeeper_change_order_printing_search.json")
        # with open("../data/jsonschema/50_storekeeper_change_order_printing_search.json", "r", encoding = "utf-8") as f:
        #     shcema = json.load(f)
