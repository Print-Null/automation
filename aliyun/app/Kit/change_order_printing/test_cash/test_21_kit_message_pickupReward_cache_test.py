...
@allure.feature('代收货款-COD-揽收完成-3')
class Test_kit_message_pickupReward(object):
    ...
    def test_test_kit_message_pickupReward(self, parameter,headers,address):
        ...
        # logging.info("jsonschema文件path:../data/jsonschema/9_collection_completed_3.json")
        # with open("../data/jsonschema/9_collection_completed_3.json", "r", encoding = "utf-8") as f:
        #     shcema = json.load(f)
