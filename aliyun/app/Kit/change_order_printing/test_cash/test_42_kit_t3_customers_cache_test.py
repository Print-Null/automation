...
@allure.feature('代收货款-COD-输入收件人姓名')
class Test_kit_t3_customers(object):
    ...
    def test_test_kit_t3_customers(self,headers,address):
        ...
        # logging.info("jsonschema文件path:../data/jsonschema/4_choose_recipient_name.json")
        # with open("../data/jsonschema/4_choose_recipient_name.json", "r", encoding = "utf-8") as f:
        #     shcema = json.load(f)
