...
class Test_kit_address_isSrcAddress(object):
    ...
    def test_test_kit_address_isSrcAddress(self,headers,address):
        ...
        # logging.info("jsonschema文件path:../data/jsonschema/37_get_the_modified_sender_phone.json")
        # with open("../data/jsonschema/37_get_the_modified_sender_phone.json", "r", encoding = "utf-8") as f:
        #     shcema = json.load(f)
