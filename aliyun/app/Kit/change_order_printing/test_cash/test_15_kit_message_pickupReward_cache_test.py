...
class Test_kit_message_pickupReward(object):
    ...
    def test_test_kit_message_pickupReward(self,headers,address):
        ...
        RedisBase().set('kit_message_pickupReward_' + str(_headers.index(headers)) + '_' + str(_address.index(address)) + '_["data"][0]["id"]', resp.json()["data"][0]["id"], ex=6000)
