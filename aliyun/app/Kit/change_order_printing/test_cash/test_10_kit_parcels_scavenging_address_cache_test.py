...
class Test_kit_parcels_scavenging_address(object):
    ...
    def test_test_kit_parcels_scavenging_address(self,headers,address):
        ...
        # logging.info("jsonschema文件path:../data/jsonschema/10_courier_change_order_printing_search.json")
        # with open("../data/jsonschema/10_courier_change_order_printing_search.json", "r", encoding = "utf-8") as f:
        #     shcema = json.load(f)
