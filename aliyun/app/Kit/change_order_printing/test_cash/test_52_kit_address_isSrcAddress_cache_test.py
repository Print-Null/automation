...
class Test_kit_address_isSrcAddress(object):
    ...
    def test_test_kit_address_isSrcAddress(self,headers,address):
        ...
        # logging.info("jsonschema文件path:../data/jsonschema/52_get_the_modified_recipient_phone.json")
        # with open("../data/jsonschema/52_get_the_modified_recipient_phone.json", "r", encoding = "utf-8") as f:
        #     shcema = json.load(f)
