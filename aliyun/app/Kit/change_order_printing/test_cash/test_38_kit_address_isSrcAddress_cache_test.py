...
class Test_kit_address_isSrcAddress(object):
    ...
    @pytest.mark.parametrize("address",['api/courier/v1/address/$[config]modified_recipient_phone$?isSrcAddress=true'])
    ...
    def test_test_kit_address_isSrcAddress(self,headers,address):
        ...
        _address = ['api/courier/v1/address/$[config]modified_recipient_phone$?isSrcAddress=true']
        ...
        # logging.info("jsonschema文件path:../data/jsonschema/38_get_the_modified_recipient_phone.json")
        # with open("../data/jsonschema/38_get_the_modified_recipient_phone.json", "r", encoding = "utf-8") as f:
        #     shcema = json.load(f)
