...
@allure.feature('妥投-订单1')
class Test_kit_pre_delivery_confirm_1(object):
    ...
    @pytest.mark.parametrize("address",['api/courier/v1/ticket/parcels/$kit_pickups_parcel_1_0_0_["data"]["parcel_info"]["pno"]$/delivery_confirm?isFromScanner=false'])
    @pytest.mark.run(order=598)
    def test_test_kit_pre_delivery_confirm_1(self, parameter,headers,address):
        ...
        _address = ['api/courier/v1/ticket/parcels/$kit_pickups_parcel_1_0_0_["data"]["parcel_info"]["pno"]$/delivery_confirm?isFromScanner=false']
