...
@allure.feature('查看本网点上传的包裹')
class Test_kit_headless_get_headless(object):
    ...
    def test_test_kit_headless_get_headless(self,headers,address):
        ...
        # logging.info("jsonschema文件path:../data/jsonschema/3_check_the_packages_uploaded_by_our_website.json")
        # with open("../data/jsonschema/3_check_the_packages_uploaded_by_our_website.json", "r", encoding = "utf-8") as f:
        #     shcema = json.load(f)
