...
@allure.feature('仓管员-拆包-手动输入集包号-2')
class Test_kit_v1_parcels_v0(object):
    ...
    @pytest.mark.parametrize("address",['api/courier/v1/pack/get_unpack/$kit_valid_search_#headers#_0_[pack_no]$'])
    ...
    def test_test_kit_v1_parcels_v0(self, parameter,headers,address):
        ...
        _address = ['api/courier/v1/pack/get_unpack/$kit_valid_search_#headers#_0_[pack_no]$']
