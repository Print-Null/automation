...
@allure.feature('仓管员-到件入仓-输入出车凭证编号')
class Test_kit_fleet_proof(object):
    ...
    @pytest.mark.parametrize("address",['api/courier/v1/fleet/proof/$ms_van_proof_0_0_0_["data"]["id"]$'])
    ...
    def test_test_kit_fleet_proof(self,headers,address):
        ...
        _address = ['api/courier/v1/fleet/proof/$ms_van_proof_0_0_0_["data"]["id"]$']
