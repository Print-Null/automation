...
@allure.feature('集包-查集包')
class Test_kit_pack_second_get_pack(object):
    ...
    @pytest.mark.parametrize("address",['api/courier/v1/pack/get_pack/$kit_valid_search_0_0_[pack_no]$?isFromScanner=false'])
    @pytest.mark.run(order=57)
    def test_test_kit_pack_second_get_pack(self,headers,address):
        ...
        _address = ['api/courier/v1/pack/get_pack/$kit_valid_search_0_0_[pack_no]$?isFromScanner=false']
