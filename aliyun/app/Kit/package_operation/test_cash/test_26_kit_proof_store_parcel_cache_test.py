...
@allure.feature('仓管员-发件出仓-获取车辆信息-2')
class Test_kit_proof_store_parcel(object):
    ...
    @pytest.mark.parametrize("address",['api/courier/v1/fleet/proof/store_parcel/$ms_van_proof_0_0_0_["data"]["id"]$'])
    @pytest.mark.run(order=26)
    def test_test_kit_proof_store_parcel(self,headers,address):
        ...
        _address = ['api/courier/v1/fleet/proof/store_parcel/$ms_van_proof_0_0_0_["data"]["id"]$']
