...
@allure.feature('仓管员-发件出仓-获取车辆信息-1')
class Test_kit_line_store(object):
    ...
    @pytest.mark.parametrize("address",['api/courier/v1/fleet/van/line/store/$ms_van_line_0_0_["data"]["items"][0]["id"]$'])
    @pytest.mark.run(order=25)
    def test_test_kit_line_store(self,headers,address):
        ...
        _address = ['api/courier/v1/fleet/van/line/store/$ms_van_line_0_0_["data"]["items"][0]["id"]$']
