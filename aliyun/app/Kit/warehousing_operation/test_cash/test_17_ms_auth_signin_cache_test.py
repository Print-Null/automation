...
@allure.feature('MS-登录')
class Test_ms_auth_signin(object):

    @pytest.mark.parametrize("parameter",["{'login': '$[config]p_outlet_manager_login$', 'password': '$[config]p_outlet_manager_pwd$'}", "{'login': '$[config]c_outlet_manager_login$', 'password': '$[config]c_outlet_manager_pwd$'}", "{'login': '$[config]ms_houtai_login_user$', 'password': '$[config]ms_houtai_login_pwd$'}"])
    ...
    def test_test_ms_auth_signin(self, parameter,headers,address):
        ...
        _parameter = ["{'login': '$[config]p_outlet_manager_login$', 'password': '$[config]p_outlet_manager_pwd$'}", "{'login': '$[config]c_outlet_manager_login$', 'password': '$[config]c_outlet_manager_pwd$'}", "{'login': '$[config]ms_houtai_login_user$', 'password': '$[config]ms_houtai_login_pwd$'}"]
