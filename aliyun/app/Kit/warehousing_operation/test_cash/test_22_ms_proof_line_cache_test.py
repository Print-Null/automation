...
class Test_ms_proof_line(object):
    ...
    @pytest.mark.parametrize("address",['ms/api/fleet/van/proof/line/$ms_van_line_0_0_["data"]["items"][0]["id"]$?startDate=$[python]time.strftime("%Y-%m-%d",time.gmtime())$'])
    @pytest.mark.run(order=22)
    def test_test_ms_proof_line(self,headers,address):
        ...
        _address = ['ms/api/fleet/van/proof/line/$ms_van_line_0_0_["data"]["items"][0]["id"]$?startDate=$[python]time.strftime("%Y-%m-%d",time.gmtime())$']
