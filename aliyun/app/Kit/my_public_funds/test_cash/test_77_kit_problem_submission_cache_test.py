...
@allure.feature('到付运费-仓管员问题单提交-提交3')
class Test_kit_problem_submission(object):

    @pytest.mark.parametrize("parameter",["{'difficulty_marker_category': 29, 'image_keys': ['difficulty/1593502500-6552bdabf7f74b05a01f09704dee0c92.jpg'], 'remark': ''}"])
    ...
    def test_test_kit_problem_submission(self, parameter,headers,address):
        ...
        _parameter = ["{'difficulty_marker_category': 29, 'image_keys': ['difficulty/1593502500-6552bdabf7f74b05a01f09704dee0c92.jpg'], 'remark': ''}"]
