...
class Test_ms_store_receivable_bill(object):
    ...
    @pytest.mark.parametrize("address",['ms/api/store/receivable_bill?closed=0&staffInfoId=$my_public_funds_courier_login$&pageSize=20&pageNum=1&startTime=$kit_my_public_funds_lists_uncleared_#headers#_0_["data"]["items"][0]["business_date_text"]$&endTime=$kit_my_public_funds_lists_uncleared_#headers#_0_["data"]["items"][0]["business_date_text"]$'])
    ...
    def test_test_ms_store_receivable_bill(self, parameter,headers,address):
        ...
        _address = ['ms/api/store/receivable_bill?closed=0&staffInfoId=$my_public_funds_courier_login$&pageSize=20&pageNum=1&startTime=$kit_my_public_funds_lists_uncleared_#headers#_0_["data"]["items"][0]["business_date_text"]$&endTime=$kit_my_public_funds_lists_uncleared_#headers#_0_["data"]["items"][0]["business_date_text"]$']
