...
class Test_ms_store_parcel_v0(object):
    ...
    @pytest.mark.parametrize("address",['ms/api/store/parcel_v0/$kit_pickups_parcel_0_#headers#_0_["data"]["parcel_info"]["pno"]$'])
    ...
    def test_test_ms_store_parcel_v0(self, parameter,headers,address):
        ...
        RedisBase().set('ms_store_parcel_v0_' + str(_headers.index(headers)) + '_' + str(_address.index(address)) + '_["data"]["parcel_info"]["returned_pno"]', resp.json()["data"]["parcel_info"]["returned_pno"], ex=6000)
