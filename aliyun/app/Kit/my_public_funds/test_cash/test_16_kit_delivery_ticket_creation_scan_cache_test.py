...
class Test_kit_delivery_ticket_creation_scan(object):
    ...
    @pytest.mark.parametrize("address",['api/courier/v1/parcels/$kit_pickups_parcel_0_#headers#_0_["data"]["parcel_info"]["pno"]$/delivery_ticket_creation_scan?isFromScanner=false'])
    ...
    def test_test_kit_delivery_ticket_creation_scan(self, parameter,headers,address):
        ...
        _address = ['api/courier/v1/parcels/$kit_pickups_parcel_0_#headers#_0_["data"]["parcel_info"]["pno"]$/delivery_ticket_creation_scan?isFromScanner=false']
