...
@allure.feature('到付运费-仓管员问题单提交-输入订单号')
class Test_kit_marker_info(object):
    ...
    @pytest.mark.parametrize("address",['api/courier/v1/parcels/$kit_pickups_parcel_0_0_0_["data"]["parcel_info"]["pno"]$/marker_info?isFromScanner=false'])
    @pytest.mark.run(order=75)
    def test_test_kit_marker_info(self,headers,address):
        ...
        _address = ['api/courier/v1/parcels/$kit_pickups_parcel_0_0_0_["data"]["parcel_info"]["pno"]$/marker_info?isFromScanner=false']
