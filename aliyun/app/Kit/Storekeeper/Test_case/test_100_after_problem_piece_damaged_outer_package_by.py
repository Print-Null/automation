...
class Test_After_Problem_Piece_Damaged_Out_Package_By():
    ...
    def test_after_problem_piece_damaged_outer_package_by(self,i):
        comm = Common_data()
        true = True
        ...
        data = {"marker_category": 4, "upload_photo": true}
