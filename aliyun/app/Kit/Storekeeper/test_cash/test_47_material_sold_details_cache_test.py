...
class Test_material_sold_details(object):
    ...
    @pytest.mark.parametrize("address",['api/courier/v1/staff/material/desc?itemCode=4&businessDate=$[python]str(datetime.date.today())$&pageNum=1&pageSize=20'])
    @pytest.mark.run(order=47)
    def test_test_material_sold_details(self,headers,address):
