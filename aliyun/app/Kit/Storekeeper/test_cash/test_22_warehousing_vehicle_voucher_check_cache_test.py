...
class Test_warehousing_vehicle_voucher_check(object):
    ...
    def test_test_warehousing_vehicle_voucher_check(self,headers,address):
        ...
        # logging.info("jsonschema文件path:../data/jsonschema/22warehousing_vehicle_voucher_check.json")
        # with open("../data/jsonschema/22warehousing_vehicle_voucher_check.json", "r", encoding = "utf-8") as f:
        #     shcema = json.load(f)
