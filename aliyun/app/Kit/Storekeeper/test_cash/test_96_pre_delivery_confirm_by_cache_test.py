...
class Test_pre_delivery_confirm_by(object):
    ...
    @pytest.mark.parametrize("address",['api/courier/v1/ticket/parcels/$courier_pno_number34$/pre_delivery_confirm'])
    @pytest.mark.run(order=96)
    def test_test_pre_delivery_confirm_by(self,headers,address):
        ...
        _address = ['api/courier/v1/ticket/parcels/$courier_pno_number34$/pre_delivery_confirm']
        ...
        # logging.info("jsonschema文件path:../data/jsonschema/96pre_delivery_confirm_by.json")
        # with open("../data/jsonschema/96pre_delivery_confirm_by.json", "r", encoding = "utf-8") as f:
        #     shcema = json.load(f)
