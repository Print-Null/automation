...
class Test_conventional_circuit_vehicle_entry_by(object):
    ...
    def test_test_conventional_circuit_vehicle_entry_by(self,headers,address):
        ...
        # logging.info("jsonschema文件path:../data/jsonschema/73conventional_circuit_vehicle_entry_by.json")
        # with open("../data/jsonschema/73conventional_circuit_vehicle_entry_by.json", "r", encoding = "utf-8") as f:
        #     shcema = json.load(f)
