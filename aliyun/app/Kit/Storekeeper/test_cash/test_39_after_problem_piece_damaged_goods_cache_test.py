...
class Test_after_problem_piece_damaged_goods(object):
    ...
    @pytest.mark.parametrize("address",['api/courier/v1/ticket/parcels/$courier_pno_number13$/mark'])
    @pytest.mark.run(order=39)
    def test_test_after_problem_piece_damaged_goods(self, parameter,headers,address):
        ...
        _address = ['api/courier/v1/ticket/parcels/$courier_pno_number13$/mark']
        ...
        # logging.info("jsonschema文件path:../data/jsonschema/39after_problem_piece_damaged_goods.json")
        # with open("../data/jsonschema/39after_problem_piece_damaged_goods.json", "r", encoding = "utf-8") as f:
        #     shcema = json.load(f)
