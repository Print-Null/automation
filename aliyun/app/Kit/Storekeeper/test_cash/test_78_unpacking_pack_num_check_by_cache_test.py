...
class Test_unpacking_pack_num_check_by(object):
    ...
    @pytest.mark.parametrize("address",['api/courier/v1/pack/unseal/verify/$pack_no$'])
    @pytest.mark.run(order=78)
    def test_test_unpacking_pack_num_check_by(self,headers,address):
        ...
        # logging.info("jsonschema文件path:../data/jsonschema/78unpacking_pack_num_check_by.json")
        # with open("../data/jsonschema/78unpacking_pack_num_check_by.json", "r", encoding = "utf-8") as f:
        #     shcema = json.load(f)
