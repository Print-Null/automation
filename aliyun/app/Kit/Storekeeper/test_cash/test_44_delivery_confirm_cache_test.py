...
class Test_delivery_confirm(object):
    ...
    @pytest.mark.parametrize("address",['api/courier/v1/ticket/parcels/$courier_pno_number17$/delivery_confirm'])
    @pytest.mark.run(order=44)
    def test_test_delivery_confirm(self, parameter,headers,address):
        ...
        _address = ['api/courier/v1/ticket/parcels/$courier_pno_number17$/delivery_confirm']
        ...
        # logging.info("jsonschema文件path:../data/jsonschema/44delivery_confirm.json")
        # with open("../data/jsonschema/44delivery_confirm.json", "r", encoding = "utf-8") as f:
        #     shcema = json.load(f)
