...
class Test_delivery_confirm_deliveryReward_by(object):
    ...
    @pytest.mark.parametrize("address",['api/courier/v1/message/deliveryReward/$courier_pno_number34$'])
    @pytest.mark.run(order=98)
    def test_test_delivery_confirm_deliveryReward_by(self,headers,address):
        ...
        _address = ['api/courier/v1/message/deliveryReward/$courier_pno_number34$']
        ...
        # logging.info("jsonschema文件path:../data/jsonschema/98delivery_confirm_deliveryReward_by.json")
        # with open("../data/jsonschema/98delivery_confirm_deliveryReward_by.json", "r", encoding = "utf-8") as f:
        #     shcema = json.load(f)
