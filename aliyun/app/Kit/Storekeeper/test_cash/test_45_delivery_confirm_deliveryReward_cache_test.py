...
class Test_delivery_confirm_deliveryReward(object):
    ...
    @pytest.mark.parametrize("address",['api/courier/v1/message/deliveryReward/$courier_pno_number17$'])
    @pytest.mark.run(order=45)
    def test_test_delivery_confirm_deliveryReward(self,headers,address):
        ...
        _address = ['api/courier/v1/message/deliveryReward/$courier_pno_number17$']
        ...
        # logging.info("jsonschema文件path:../data/jsonschema/45delivery_confirm_deliveryReward.json")
        # with open("../data/jsonschema/45delivery_confirm_deliveryReward.json", "r", encoding = "utf-8") as f:
        #     shcema = json.load(f)
