...
@allure.feature('车辆出港功能->出车凭证线路校验')
class Test_vehicle_departure_check(object):
    ...
    def test_test_vehicle_departure_check(self,headers,address):
        ...
        # logging.info("jsonschema文件path:../data/jsonschema/18vehicle_departure_check.json")
        # with open("../data/jsonschema/18vehicle_departure_check.json", "r", encoding = "utf-8") as f:
        #     shcema = json.load(f)
