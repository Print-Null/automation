...
class Test_unpacking_pack_num_check(object):
    ...
    def test_test_unpacking_pack_num_check(self,headers,address):
        ...
        # logging.info("jsonschema文件path:../data/jsonschema/25unpacking_pack_num_check.json")
        # with open("../data/jsonschema/25unpacking_pack_num_check.json", "r", encoding = "utf-8") as f:
        #     shcema = json.load(f)
