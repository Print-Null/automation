...
class Test_pre_delivery_confirm(object):
    ...
    @pytest.mark.parametrize("address",['api/courier/v1/ticket/parcels/$courier_pno_number17$/pre_delivery_confirm'])
    @pytest.mark.run(order=43)
    def test_test_pre_delivery_confirm(self,headers,address):
        ...
        _address = ['api/courier/v1/ticket/parcels/$courier_pno_number17$/pre_delivery_confirm']
        ...
        # logging.info("jsonschema文件path:../data/jsonschema/43pre_delivery_confirm.json")
        # with open("../data/jsonschema/43pre_delivery_confirm.json", "r", encoding = "utf-8") as f:
        #     shcema = json.load(f)
