...
class Test_callback_lazada_pre_order(object):
    ...
    def test_test_callback_lazada_pre_order(self, parameter,headers,address):
        ...
        _address = ['/callback/lazada/pre_order']
        ...
        RedisBase().set('callback_lazada_pre_order_' + str(_parameter.index(parameter)) + '_' + str(_headers.index(headers)) + '_' + str(_address.index(address)) + '_["res"]["shipment"]["con_no"]', resp.json()["res"]["shipment"]["con_no"], ex=6000)
