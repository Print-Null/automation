...
@allure.feature('open_v3下单')
class Test_open_v3_orders(object):

    @pytest.mark.parametrize("parameter",['{\'mchId\': \'$[config]merchant_id$\', \'nonceStr\': \'$[python]str(int(time.mktime(time.strptime(str(datetime.datetime.now()),"%Y-%m-%d %H:%M:%S.%f"))))$\', \'sign\': \'sha256\', \'outTradeNo\': \'$[python]str(random.randint(1000000000,9999999999999999999999999))$\', \'articleCategory\': \'$[python]random.choice([0,1,2,3,4,5])$\', \'codAmount\': \'$[python]random.randrange(100,5000001,100)$\', \'codEnabled\': 1, \'dstCityName\': \'พระนครศรีอยุธยา\', \'dstDetailAddress\': \'กะ123มัง\', \'dstHomePhone\': \'$[python]"0136"+str(random.randint(100000,999999))$\', \'dstName\': \'$[python]"open order receiver"+str(random.randint(1,99999))$\', \'dstPhone\': \'$[python]"0135"+str(random.randint(100000,999999))$\', \'dstPostalCode\': \'13000\', \'dstProvinceName\': \'พระนครศรีอยุธยา\', \'expressCategory\': 1, \'insureDeclareValue\': \'\', \'insured\': 0, \'remark\': \'-\', \'srcCityName\': \'บางคอแหลม\', \'srcDetailAddress\': \'88 หมู่ 8 อาคารหลวงไทยทาวเวอร์ ชั้น 3 ถนนพุทธมณฑลสา\', \'srcName\': \'$[python]"open order sender"+str(random.randint(1,99999))$\', \'srcPhone\': \'$[python]"0134"+str(random.randint(100000,999999))$\', \'srcPostalCode\': \'10120\', \'srcProvinceName\': \'กรุงเทพ\', \'weight\': \'$[python]random.randint(1,30000)$\', \'srcDistrictName\': \'\', \'dstDistrictName\': \'\', \'length\': \'$[python]random.randint(1,100)$\', \'width\': \'$[python]random.randint(1,100)$\', \'height\': \'$[python]random.randint(1,80)$\', \'returnReceiptEnabled\': \'\', \'returnReceiptNo\': \'\'}', '{\'mchId\': \'$[config]merchant_id$\', \'nonceStr\': \'$[python]str(int(time.mktime(time.strptime(str(datetime.datetime.now()),"%Y-%m-%d %H:%M:%S.%f"))))$\', \'sign\': \'sha256\', \'outTradeNo\': \'$[python]str(random.randint(1000000000,9999999999999999999999999))$\', \'articleCategory\': \'$[python]random.choice([0,1,2,3,4,5])$\', \'codAmount\': 0, \'codEnabled\': 0, \'dstCityName\': \'พระนครศรีอยุธยา\', \'dstDetailAddress\': \'กะ123มัง\', \'dstHomePhone\': \'$[python]"0136"+str(random.randint(100000,999999))$\', \'dstName\': \'$[python]"open order receiver"+str(random.randint(1,99999))$\', \'dstPhone\': \'$[python]"0135"+str(random.randint(100000,999999))$\', \'dstPostalCode\': \'13000\', \'dstProvinceName\': \'พระนครศรีอยุธยา\', \'expressCategory\': 1, \'insureDeclareValue\': 0, \'insured\': 0, \'remark\': \'-\', \'srcCityName\': \'บางคอแหลม\', \'srcDetailAddress\': \'88 หมู่ 8 อาคารหลวงไทยทาวเวอร์ ชั้น 3 ถนนพุทธมณฑลสา\', \'srcName\': \'$[python]"open order sender"+str(random.randint(1,99999))$\', \'srcPhone\': \'$[python]"0134"+str(random.randint(100000,999999))$\', \'srcPostalCode\': \'10120\', \'srcProvinceName\': \'กรุงเทพ\', \'weight\': \'$[python]random.randint(1,30000)$\', \'srcDistrictName\': \'\', \'dstDistrictName\': \'\', \'length\': \'$[python]random.randint(1,100)$\', \'width\': \'$[python]random.randint(1,100)$\', \'height\': \'$[python]random.randint(1,80)$\', \'returnReceiptEnabled\': \'\', \'returnReceiptNo\': \'\'}'])
    ...
    @pytest.mark.parametrize("address",['/open/v3/orders'])
    @pytest.mark.run(order=18)
    def test_test_open_v3_orders(self, parameter,headers,address):
        ...
        RedisBase().set('open_v3_orders_' + str(_parameter.index(parameter)) + '_' + str(_headers.index(headers)) + '_' + str(_address.index(address)) + '_["data"]["pno"]', resp.json()["data"]["pno"], ex=6000)
