...
@allure.feature('查询商户所有仓库')
class Test_open_v1_warehouse(object):
    ...
    @pytest.mark.parametrize("address",['/open/v1/warehouses'])
    @pytest.mark.run(order=13)
    def test_test_open_v1_warehouse(self, parameter,headers,address):
        ...
        RedisBase().set('open_v1_warehouse_' + str(_parameter.index(parameter)) + '_' + str(_headers.index(headers)) + '_' + str(_address.index(address)) + '_["data"][0]["warehouseNo"]', resp.json()["data"][0]["warehouseNo"], ex=6000)
