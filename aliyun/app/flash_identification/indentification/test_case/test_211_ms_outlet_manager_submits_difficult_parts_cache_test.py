...
class Test_ms_outlet_manager_submits_difficult_parts(object):
    ...
    @pytest.mark.parametrize("parameter",['{\'difficulty_marker_category\': 21, \'remark\': \'短少\', \'image_keys\': [{\'image_name\': \'努力.jpg\', \'image_key\': \'difficulty/1593782603-d9f133c6402c4e7ab1abacc0fe901cfc.jpg\'}], \'pno\': \'$courier_write_order_3_0_0_["data"]["parcel_info"]["pno"]$\', \'delivery_staff_id\': \'\'}'])
    ...
    def test_test_ms_outlet_manager_submits_difficult_parts(self, parameter,headers,address):
        ...
        _parameter = ['{\'difficulty_marker_category\': 21, \'remark\': \'短少\', \'image_keys\': [{\'image_name\': \'努力.jpg\', \'image_key\': \'difficulty/1593782603-d9f133c6402c4e7ab1abacc0fe901cfc.jpg\'}], \'pno\': \'$courier_write_order_3_0_0_["data"]["parcel_info"]["pno"]$\', \'delivery_staff_id\': \'\'}']
