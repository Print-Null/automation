...
class Test_record_this_order_query(object):
    ...
    @pytest.mark.parametrize("address",['ms/api/customer/issues/parcle?pno=$courier_write_order_4_0_0_["data"]["parcel_info"]["pno"]$'])
    ...
    def test_test_record_this_order_query(self,headers,address):
        ...
        _address = ['ms/api/customer/issues/parcle?pno=$courier_write_order_4_0_0_["data"]["parcel_info"]["pno"]$']
