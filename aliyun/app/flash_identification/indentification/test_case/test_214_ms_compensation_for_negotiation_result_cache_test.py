...
class Test_ms_compensation_for_negotiation_result(object):
    ...
    @pytest.mark.parametrize("address",['ms/api/customer/diff_tickets/$ms_communicated_with_outlets_["data"]["items"][0]["id"]$/consult'])
    ...
    def test_test_ms_compensation_for_negotiation_result(self, parameter,headers,address):
        ...
        _address = ['ms/api/customer/diff_tickets/$ms_communicated_with_outlets_["data"]["items"][0]["id"]$/consult']
