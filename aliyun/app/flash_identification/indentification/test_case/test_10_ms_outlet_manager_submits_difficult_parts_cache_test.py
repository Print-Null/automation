...
@allure.feature('ms网点经理-提交疑难件（货物丢失）')
class Test_ms_outlet_manager_submits_difficult_parts(object):

    @pytest.mark.parametrize("parameter",['{\'difficulty_marker_category\': 22, \'remark\': \'自动化货物丢失，自动化货物丢失\', \'image_keys\': [], \'pno\': \'$courier_write_order_1_0_0_["data"]["parcel_info"]["pno"]$\', \'delivery_staff_id\': \'\'}'])
    ...
    def test_test_ms_outlet_manager_submits_difficult_parts(self, parameter,headers,address):
        ...
        _parameter = ['{\'difficulty_marker_category\': 22, \'remark\': \'自动化货物丢失，自动化货物丢失\', \'image_keys\': [], \'pno\': \'$courier_write_order_1_0_0_["data"]["parcel_info"]["pno"]$\', \'delivery_staff_id\': \'\'}']
