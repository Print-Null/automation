...
class Test_courier_collection_finish(object):
    ...
    @pytest.mark.parametrize("address",['api/courier/v1/ticket/$courier_write_order_0_0_0_["data"]["ticket_pickup_id"]$', 'api/courier/v1/ticket/$courier_write_order_1_0_0_["data"]["ticket_pickup_id"]$'])
    ...
    def test_test_courier_collection_finish(self, parameter,headers,address):
        ...
        _address = ['api/courier/v1/ticket/$courier_write_order_0_0_0_["data"]["ticket_pickup_id"]$', 'api/courier/v1/ticket/$courier_write_order_1_0_0_["data"]["ticket_pickup_id"]$']
