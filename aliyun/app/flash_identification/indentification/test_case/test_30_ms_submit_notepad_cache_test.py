...
class Test_ms_submit_notepad(object):
    ...
    @pytest.mark.parametrize("parameter",['{\'pno\': \'$courier_write_order_5_0_0_["data"]["parcel_info"]["pno"]$\', \'grade\': \'\', \'channel_category\': 3, \'requester_category\': 1, \'customer_name\': \'自动化姓名\', \'customer_phone\': \'\', \'customer_email\': \'\', \'request_sup_type\': 14, \'request_sub_type\': 141, \'remark\': \'自动化客服记录本提交索赔-破损/短少索赔\', \'opened\': False, \'back_visit_category\': \'\', \'need_ring_back\': False, \'assign_to_me\': False, \'need_close\': True, \'customer_team\': 1, \'images\': []}'])
    ...
    def test_test_ms_submit_notepad(self, parameter,headers,address):
        ...
        _parameter = ['{\'pno\': \'$courier_write_order_5_0_0_["data"]["parcel_info"]["pno"]$\', \'grade\': \'\', \'channel_category\': 3, \'requester_category\': 1, \'customer_name\': \'自动化姓名\', \'customer_phone\': \'\', \'customer_email\': \'\', \'request_sup_type\': 14, \'request_sub_type\': 141, \'remark\': \'自动化客服记录本提交索赔-破损/短少索赔\', \'opened\': False, \'back_visit_category\': \'\', \'need_ring_back\': False, \'assign_to_me\': False, \'need_close\': True, \'customer_team\': 1, \'images\': []}']
