...
class Test_warehouse_goods_loss(object):
    ...
    @pytest.mark.parametrize("address",['api/courier/v1/parcels/$courier_write_order_1_0_0_["data"]["parcel_info"]["pno"]$/problem_submission'])
    ...
    def test_test_warehouse_goods_loss(self, parameter,headers,address):
        ...
        _address = ['api/courier/v1/parcels/$courier_write_order_1_0_0_["data"]["parcel_info"]["pno"]$/problem_submission']
