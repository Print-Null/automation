...
class Test_ms_communicated_with_outlets(object):
    ...
    def test_test_ms_communicated_with_outlets(self, parameter,headers,address):
        ...
        RedisBase().set('7ms_communicated_with_outlets_' + str(_parameter.index(parameter)) + '_' + str(_headers.index(headers)) + '_' + str(_address.index(address)) + '_["data"]["items"][0]["id"]', resp.json()["data"]["items"][0]["id"], ex=6000)
