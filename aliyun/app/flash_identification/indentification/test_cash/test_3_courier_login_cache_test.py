...
class Test_courier_login(object):
    ...
    @pytest.mark.parametrize("parameter",["{'login': '$[config]indentifi_kit_usr$', 'password': '$[config]indentifi_kit_pwd$', 'clientid': '8698940239062391583120286987', 'clientsd': '1583120286995', 'os': 'android', 'version': '$[config]login_version$'}"])
    ...
    def test_test_courier_login(self, parameter,headers,address):
        ...
        _parameter = ["{'login': '$[config]indentifi_kit_usr$', 'password': '$[config]indentifi_kit_pwd$', 'clientid': '8698940239062391583120286987', 'clientsd': '1583120286995', 'os': 'android', 'version': '$[config]login_version$'}"]
