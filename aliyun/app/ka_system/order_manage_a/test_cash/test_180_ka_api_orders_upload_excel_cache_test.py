...
class Test_ka_api_orders_upload_excel(object):
    ...
    @pytest.mark.parametrize("headers",['{\'Accept\': \'application/json, text/plain, */*\', \'Accept-Language\': \'en\', \'X-KA-SESSION-ID\': \'$ka_api_auth_signin_0_0_0_["data"]["session_id"]$\'}'])
    ...
    def test_test_ka_api_orders_upload_excel(self,headers,address):
        ...
        _headers = ['{\'Accept\': \'application/json, text/plain, */*\', \'Accept-Language\': \'en\', \'X-KA-SESSION-ID\': \'$ka_api_auth_signin_0_0_0_["data"]["session_id"]$\'}']
