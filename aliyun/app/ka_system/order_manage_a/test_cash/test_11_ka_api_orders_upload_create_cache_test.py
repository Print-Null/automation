...
class Test_ka_api_orders_upload_create(object):
    ...
    @pytest.mark.parametrize("headers",['{\'content-type\': \'application/json;charset=UTF-8\', \'Accept\': \'application/json, text/plain, */*\', \'Accept-Language\': \'zh-CN\', \'X-KA-SESSION-ID\': \'$ka_api_auth_signin_0_0_0_["data"]["session_id"]$\'}'])
    ...
    def test_test_ka_api_orders_upload_create(self, parameter,headers,address):
        ...
        _headers = ['{\'content-type\': \'application/json;charset=UTF-8\', \'Accept\': \'application/json, text/plain, */*\', \'Accept-Language\': \'zh-CN\', \'X-KA-SESSION-ID\': \'$ka_api_auth_signin_0_0_0_["data"]["session_id"]$\'}']
