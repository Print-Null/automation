...
@allure.feature('网点经理->待审批数量')
class Test_backyard_overtime_car_audit_waitAuditNum(object):
    ...
    @pytest.mark.parametrize("address",['api/_/audit/waitAuditNum'])
    @pytest.mark.run(order=7)
    def test_test_backyard_overtime_car_audit_waitAuditNum(self, parameter,headers,address):
        ...
        _address = ['api/_/audit/waitAuditNum']
