...
class Test_regional_manager_login_manager_unilateral(object):
    ...
    def test_test_regional_manager_login_manager_unilateral(self, parameter,headers,address):
        ...
        RedisBase().set('regional_manager_login_manager_unilateral_' + str(_parameter.index(parameter)) + '_' + str(_headers.index(headers)) + '_' + str(_address.index(address)) + '_["data"]["sessionid"]', resp.json()["data"]["sessionid"], ex=6000)
