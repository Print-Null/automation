...
class Test_backyard_overtime_car_ms_fleet_line_approve(object):
    ...
    def test_test_backyard_overtime_car_ms_fleet_line_approve(self,headers,address):
        ...
        RedisBase().set('backyard_overtime_car_ms_fleet_line_approve_' + str(_headers.index(headers)) + '_' + str(_address.index(address)) + '_["data"]["items"][-2]["id"]', resp.json()["data"]["items"][-2]["id"], ex=6000)
        
        RedisBase().set('backyard_overtime_car_ms_fleet_line_approve_' + str(_headers.index(headers)) + '_' + str(_address.index(address)) + '_["data"]["items"][-3]["id"]', resp.json()["data"]["items"][-3]["id"], ex=6000)
        
        RedisBase().set('backyard_overtime_car_ms_fleet_line_approve_' + str(_headers.index(headers)) + '_' + str(_address.index(address)) + '_["data"]["items"][-4]["id"]', resp.json()["data"]["items"][-4]["id"], ex=6000)
        
        RedisBase().set('backyard_overtime_car_ms_fleet_line_approve_' + str(_headers.index(headers)) + '_' + str(_address.index(address)) + '_["data"]["items"][-5]["id"]', resp.json()["data"]["items"][-5]["id"], ex=6000)
        
        RedisBase().set('backyard_overtime_car_ms_fleet_line_approve_' + str(_headers.index(headers)) + '_' + str(_address.index(address)) + '_["data"]["items"][-6]["id"]', resp.json()["data"]["items"][-6]["id"], ex=6000)
        
        RedisBase().set('backyard_overtime_car_ms_fleet_line_approve_' + str(_headers.index(headers)) + '_' + str(_address.index(address)) + '_["data"]["items"][-7]["id"]', resp.json()["data"]["items"][-7]["id"], ex=6000)
        
        RedisBase().set('backyard_overtime_car_ms_fleet_line_approve_' + str(_headers.index(headers)) + '_' + str(_address.index(address)) + '_["data"]["items"][-8]["id"]', resp.json()["data"]["items"][-8]["id"], ex=6000)
