...
@allure.feature('网点经理->已处理列表展示')
class Test_backyard_overtime_car_api_auditList_getList2(object):

    @pytest.mark.parametrize("parameter",["{'audit_show_type': 2, 'audit_state_type': 2, 'page_num': 1}"])
    ...
    def test_test_backyard_overtime_car_api_auditList_getList2(self, parameter,headers,address):
        baseTest = BaseTestCase()
    
        _parameter = ["{'audit_show_type': 2, 'audit_state_type': 2, 'page_num': 1}"]
