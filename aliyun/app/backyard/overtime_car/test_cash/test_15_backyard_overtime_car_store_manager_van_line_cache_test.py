...
@allure.feature('ms线路')
class Test_backyard_overtime_car_store_manager_van_line(object):
    ...
    @pytest.mark.parametrize("address",['ms/api/setting/store/manager/van/line'])
    @pytest.mark.run(order=15)
    def test_test_backyard_overtime_car_store_manager_van_line(self,headers,address):
        ...
        _address = ['ms/api/setting/store/manager/van/line']
