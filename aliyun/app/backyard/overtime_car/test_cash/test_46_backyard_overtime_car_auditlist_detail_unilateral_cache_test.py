...
class Test_backyard_overtime_car_auditlist_detail_unilateral(object):
    ...
    def test_test_backyard_overtime_car_auditlist_detail_unilateral(self, parameter,headers,address):
        baseTest = BaseTestCase()
    
        _parameter = ['{\'id\': \'$backyard_overtime_car_api_auditList_getList_unilateral_0_0_0_["data"]["dataList"][0]["id"]$\', \'type\': 12, \'isCommit\': 2}', '{\'id\': \'$backyard_overtime_car_api_auditList_getList_unilateral_0_0_0_["data"]["dataList"][1]["id"]$\', \'type\': 12, \'isCommit\': 2}', '{\'id\': \'$backyard_overtime_car_api_auditList_getList_unilateral_0_0_0_["data"]["dataList"][2]["id"]$\', \'type\': 12, \'isCommit\': 2}', '{\'id\': \'$backyard_overtime_car_api_auditList_getList_unilateral_0_0_0_["data"]["dataList"][3]["id"]$\', \'type\': 12, \'isCommit\': 2}', '{\'id\': \'$backyard_overtime_car_api_auditList_getList_unilateral_0_0_0_["data"]["dataList"][4]["id"]$\', \'type\': 12, \'isCommit\': 2}', '{\'id\': \'$backyard_overtime_car_api_auditList_getList_unilateral_0_0_0_["data"]["dataList"][5]["id"]$\', \'type\': 12, \'isCommit\': 2}', '{\'id\': \'$backyard_overtime_car_api_auditList_getList_unilateral_0_0_0_["data"]["dataList"][6]["id"]$\', \'type\': 12, \'isCommit\': 2}', '{\'id\': \'$backyard_overtime_car_api_auditList_getList_unilateral_0_0_0_["data"]["dataList"][7]["id"]$\', \'type\': 12, \'isCommit\': 2}']
        ...
        RedisBase().set('backyard_overtime_car_auditlist_detail_unilateral_' + str(_parameter.index(parameter)) + '_' + str(_headers.index(headers)) + '_' + str(_address.index(address)) + '_["data"]["head"]["id"]', resp.json()["data"]["head"]["id"], ex=6000)
