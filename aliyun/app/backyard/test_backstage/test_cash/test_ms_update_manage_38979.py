...
class Test_Ms_Update_Manager_38979():
    def setup(self):
    ...
    def test_ms_manager_38979(self):
        ...
        if self.runenv_py == 'training':
            data_tra = json.dumps(read_json_file("ms_update_manage_38979_tra")) #预发布环境网点经理
