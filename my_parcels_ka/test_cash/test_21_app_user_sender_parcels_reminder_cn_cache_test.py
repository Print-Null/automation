...
class Test_app_user_sender_parcels_reminder_cn(object):
    ...
    def test_test_app_user_sender_parcels_reminder_cn(self, parameter,headers,address):
        ...
        logging.info("jsonschema文件path:../data/jsonschema/21_app_user_sender_parcels_reminder_cn.json")
        with open("../data/jsonschema/21_app_user_sender_parcels_reminder_cn.json", "r", encoding = "utf-8") as f:
            shcema = json.load(f)
