...
class Test_kit_user_sender_courier_new_device_login_cn(object):
    ...
    def test_test_kit_user_sender_courier_new_device_login_cn(self, parameter,headers,address):
        ...
        logging.info("jsonschema文件path:../data/jsonschema/7_kit_user_sender_courier_new_device_login_cn.json")
        with open("../data/jsonschema/7_kit_user_sender_courier_new_device_login_cn.json", "r", encoding = "utf-8") as f:
            shcema = json.load(f)
