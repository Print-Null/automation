...
class Test_kit_user_sender_courier_parcels_delivery_confirm_cn(object):
    ...
    @pytest.mark.parametrize("parameter",["{'signer_category': 0, 'sign_image_key': 'deliveryPickupsMarkUpload/1554113259-2ee455ae43ac41208ae7a6396f462e15', 'signer_content': '$[config]dst_name$', 'call_duration': 200}"])
    ...
    def test_test_kit_user_sender_courier_parcels_delivery_confirm_cn(self, parameter,headers,address):
        ...
        _parameter = ["{'signer_category': 0, 'sign_image_key': 'deliveryPickupsMarkUpload/1554113259-2ee455ae43ac41208ae7a6396f462e15', 'signer_content': '$[config]dst_name$', 'call_duration': 200}"]
