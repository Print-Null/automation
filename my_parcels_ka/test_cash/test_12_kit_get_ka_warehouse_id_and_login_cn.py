...
class Test_kit_get_ka_warehouse_id_and_login_cn(object):

    @pytest.mark.run(order=12)
    def test_test_kit_get_ka_warehouse_id_and_login_cn(self):
        ...
        if env == "trunk":
            ...
            src_postal_code_trunk = readConfigObj.get_config(env, "ka_src_postal_code")
            ...
            RedisBase().set('kit_get_ka_warehouse_id_and_login_cn_["data"]["sessionid"]', kit_sessionid_trunk, ex=6000)
        if env == "training":
            # 超级管理员
            ...
            src_postal_code_training = readConfigObj.get_config(env, "ka_src_postal_code")
            ...
            RedisBase().set('kit_get_ka_warehouse_id_and_login_cn_["data"]["sessionid"]', kit_sessionid_training, ex=6000)
