...
class TestXueqiu:
    def setup(self):
        ...
        # 通过命令：adb logcat |grep -i displayed 获取activity
    ...
    def test_uiselector(self):
        scroll_to_element = (
            ...
            'new UiScrollable(''new UiSelector().scrollable(true).instance(0))''.scrollIntoView(''new UiSelector().text("5小时前").instance(0));')
